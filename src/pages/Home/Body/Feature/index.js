  ...
  return (
    <div className="bg-post">
      <div className="max-w-7xl mx-auto px-4 pt-10">
        <h1 className="text-[32px] text-[#5353ac] font-bold font-heading leading-tight text-center mb-4">
          리딩타임만의 믿을 수 있는 <br />
          <span className="text-[#f4a5c7] text-[55px]">
            리딩타임만의 믿을 수 있는
          </span>
          <span className="text-[#5353ac] text-[55px]">훈련과정</span>
        </h1>
